...
Self-improving toolkit for Claude Code
...
Skills load progressively via Claude Code's native progressive disclosure — only triggered skills load into context, keeping LLM focus sharp.
